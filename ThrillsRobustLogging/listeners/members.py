...
class MemberListeners(commands.Cog):
    ...
    async def on_member_update(self, before: discord.Member, after: discord.Member):
        """Logs member nickname, role, avatar, and onboarding changes."""
        ...
        # 4. Onboarding Completion
            ...
            embed = await logembeds.member_onboarding_complete(after)
            await self.cog._send_log(guild, embed, "members", "join") # Logged under the 'join' sub-category
